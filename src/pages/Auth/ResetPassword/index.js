...
const ResetPassword = ({ handleSubmit, authErrors, authFlags, resetPassword, history, resetFlags }) => {
    ...
    return (
        <div className="auth-page-wrapper">
            <form className="form-container" onSubmit={handleSubmit(handleResetPassword)}>
                ...
                <div className="form_wrapper">
                    <FormGroup>
                        <Row>
                            <Label sm={4} xs={12}>New Password</Label>
                        </Row>
                        <Row>
                            <Col sm={12}>
                                <Field
                    ...
                    <FormGroup>
                        <Row>
                            <Label sm={4} xs={12}>Confirm Password</Label>
                        </Row>
                        <Row>
                            <Col sm={12}>
                                <Field
...
const validate = (values) => {
    ...
    if (values.password && !/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{6,}$/.test(values.password)) {
